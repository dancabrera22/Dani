...
export const ANALYTES = [
  ...
  { id: 'U-CrQ',   label: 'CreatU', hidden: true, patterns: ['creatinina\\s+urin[aá]ria', 'creatinina,?\\s+urina', 'creatininuria'] },
  { id: 'U-AlbQ',  label: 'AlbU',   hidden: true, patterns: ['(micro)?albumina\\s+urin[aá]ria', 'microalbuminuria'] },
  { id: 'U-ProtQ', label: 'ProtU',  hidden: true, patterns: ['prote[ií]nas?\\s+urin[aá]rias?', 'proteinuria\\s+(isolada|de\\s+amostra)', '\\bproteinuria\\b'] },
