...
const NAME_CUT =
  /\b(convenio|conv\.|rg|cpf|cns|idade|sexo|dn\b|nasc|data|atendimento|cod\.|codigo|protocolo|os\b|registro|leito|quarto|medico|dr\.|dra\.|solicitante|prescri\w*|prontu\w*|fap\b|cip\b|local\b)\b.*/i;
